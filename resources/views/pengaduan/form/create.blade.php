<x-app-layout>
    ...
    <div class="py-8">
        ...
        @can('store', \App\Models\Complaint\Pengaduan::class)
            <form class="max-w-full mx-auto px-4 sm:px-8 lg:px-16 space-y-6" action="{{ route('pengaduan.store') }}"
        ...
        @endcan
        @cannot('store', \App\Models\Complaint\Pengaduan::class)
            <div class="max-w-full mx-auto px-4 sm:px-8 lg:px-16 space-y-6">
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg flex flex-col items-center">
                    <h2 class="font-semibold text-2xl text-gray-800 leading-tight mb-4">
                        Anda Perlu Melengkapi Profile Sebelum Bisa Membuat Pengaduan
                    </h2>
                    <a href="{{ route('account.edit') }}">
                        <x-primary-button>Lengkapi Profil</x-primary-button>
                    </a>
                </div>
            </div>
        @endcannot
