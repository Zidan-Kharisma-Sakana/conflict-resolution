        ...
        <div class="grid grid-cols-1 gap-y-4 mt-4">
            ...
            <div>
                ...
                <textarea name="pertanyaan[broker][answer]"
                    class="mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('pertanyaan.compliance') }}</textarea>
            ...
            <div>
                ...
                <textarea name="pertanyaan[legal][answer]"
                    class="mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">{{ old('pertanyaan.legal') }}</textarea>
