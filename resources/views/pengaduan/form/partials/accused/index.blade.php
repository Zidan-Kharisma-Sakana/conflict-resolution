                        ...
                        <div class="grid col-span-2 grid-cols-2 gap-x-4">
                            <div>
                                <x-form.input.text-input id="terlapor.orang_1.nama" name="terlapor.orang_1.nama"
                                    type="text" class="mt-1 block w-full" :value="old('terlapor.orang_1.nama')" required autofocus />
                                <x-form.input-error class="mt-2" :messages="$errors->get('terlapor.orang_1.nama')" />
                            </div>
                            <div>
                                <x-form.input.text-input id="terlapor.orang_1.jabatan" name="terlapor.orang_1.jabatan"
                                    type="text" class="mt-1 block w-full" :value="old('terlapor.orang_1.jabatan')" required autofocus />
                        ...
                        <div class="grid col-span-2 grid-cols-2 gap-x-4">
                            <div>
                                <x-form.input.text-input id="terlapor.orang_2.nama" name="terlapor.orang_2.nama"
                                    type="text" class="mt-1 block w-full" :value="old('terlapor.orang_2.nama')" required autofocus />
                                <x-form.input-error class="mt-2" :messages="$errors->get('terlapor.orang_2.nama')" />
                            </div>
                            <div>
                                <x-form.input.text-input id="terlapor.orang_2.jabatan" name="terlapor.orang_2.jabatan"
                                    type="text" class="mt-1 block w-full" :value="old('terlapor.orang_2.jabatan')" required autofocus />
                                <x-form.input-error class="mt-2" :messages="$errors->get('terlapor.orang_2.jabatan')" />
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-3 items-center">
                        <x-form.input-label for="terlapor.orang_1.nama" :value="__('3. Nama/Jabatan')" />
                        <div class="grid col-span-2 grid-cols-2 gap-x-4">
                            <div>
                                <x-form.input.text-input id="terlapor.orang_3.nama" name="terlapor.orang_3.nama"
                                    type="text" class="mt-1 block w-full" :value="old('terlapor.orang_3.nama')" required autofocus />
                                <x-form.input-error class="mt-2" :messages="$errors->get('terlapor.orang_3.nama')" />
                            </div>
                            <div>
                                <x-form.input.text-input id="terlapor.orang_3.jabatan" name="terlapor.orang_3.jabatan"
                                    type="text" class="mt-1 block w-full" :value="old('terlapor.orang_3.jabatan')" required autofocus />
